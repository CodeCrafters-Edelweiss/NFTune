...
import Sample from "../assets/sample_nft.png";
import "./styles.css";

const Nft = ({ tokenId, name, image, price, owner, isForSale }) => {
    return (
        <div className="">
            <div className="container nft-container">
                <img src={image} alt="" className="nft-image" />
                <div className="nft-svg" style={{}}>
                    <svg
                        width="380"
                        height="457"
                        viewBox="0 0 380 457"
                    ...
                    >
                        <path
                            d="M24.3043 0.91272H1V456H378.416V291.359"
                            stroke="white"
                            stroke-width="1.49803"
                        />
                    </svg>
                </div>
                <h3 className="nft-name">{name}</h3>
                <div className="container" style={{top: "-87.89%", position:"relative"}}>
                    <div className="row" >
                        <div
                            className="col-lg-6"
                        >
...
<path d="M5.40381 2.90942L18.1667 11.1141L5.40381 19.3188V2.90942Z" stroke="white" stroke-width="2.18792" stroke-linecap="round" stroke-linejoin="round"/>
                        ...
                        <div className="col-lg-6">
                            <button className=" btn btn-primary nft-buy-btn">BUY NFT
                                </button>
                        </div>
                    </div>
                </div>
